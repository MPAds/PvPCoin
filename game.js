...
toteAce = 0, toteTwo = 0, toteThree = 0, toteFour = 0, toteFive = 0, toteSix = 0, toteSeven = 0, toteEight = 0, toteNine = 0, toteTen = 0, toteJack = 0, toteQueen = 0, toteKing = 0, toteSpade = 0, toteHeart = 0, toteClub = 0, toteDiam = 0;
var wager = 0;
var x = 0;
...
function pickCard() {
	    document.getElementById("yourbets").innerHTML = "New hand starting. Select, and bet on a number to play.";
...
document.getElementById("betsA").innerHTML = "";
document.getElementById("bets2").innerHTML = "";
document.getElementById("bets3").innerHTML = "";
document.getElementById("bets4").innerHTML = "";
document.getElementById("bets5").innerHTML = "";
document.getElementById("bets6").innerHTML = "";
document.getElementById("bets7").innerHTML = "";
document.getElementById("bets8").innerHTML = "";
document.getElementById("bets9").innerHTML = "";
document.getElementById("bets10").innerHTML = "";
document.getElementById("betsJ").innerHTML = "";
document.getElementById("betsQ").innerHTML = "";
document.getElementById("betsK").innerHTML = "";
document.getElementById("betsDiamond").innerHTML = "";
...
var x=parseInt(document.getElementById('textbox').value,10);  // Displays the textbox for placing a wager
       if (money <= 0) {
          x = 0 ; }
...
transferCoins()
    ...
    toteA.innerHTML = toteAce;
    wA = 1;
    document.getElementById("yourbets").innerHTML = "You just bet on A, Bet again?";
	document.getElementById("betsA").innerHTML = "A";
                      }
    if (w2 == 0){  // display wager on tote board for 2
    toteTwo = toteTwo + x;
    tote2.innerHTML = toteTwo;
    w2 = 1;
	document.getElementById("yourbets").innerHTML = "Number 2 bet accepted. Feeling Lucky?";
	document.getElementById("bets2").innerHTML = "2";
                      }
    if (w3 == 0){  // display wager on tote board for 3
    toteThree = toteThree + x;
    tote3.innerHTML = toteThree;
    w3 = 1;
	document.getElementById("yourbets").innerHTML = "Bet accepted, number 3, what next?";
	document.getElementById("bets3").innerHTML = "3";
                      }
    if (w4 == 0){  // display wager on tote board for 4
    toteFour = toteFour + x;
    tote4.innerHTML = toteFour;
    w4 = 1;
	document.getElementById("yourbets").innerHTML = "Number 4, your bet is ready, good odds?";
	document.getElementById("bets4").innerHTML = "4";
                      }
    if (w5 == 0){  // display wager on tote board for 5
    toteFive = toteFive + x;
    tote5.innerHTML = toteFive;
    w5 = 1;
	document.getElementById("yourbets").innerHTML = "Okay number 5 bet accepted, I hope you win!";
	document.getElementById("bets5").innerHTML = "5";
                      }
    if (w6 == 0){  // display wager on tote board for 6
    toteSix = toteSix + x;
    tote6.innerHTML = toteSix;
    w6 = 1;
	document.getElementById("yourbets").innerHTML = "Number 6 bet accepted, you're pretty good.";
	document.getElementById("bets6").innerHTML = "6";
                      }
    if (w7 == 0){  // display wager on tote board for 7
    toteSeven = toteSeven + x;
    tote7.innerHTML = toteSeven;
    w7 = 1;
	document.getElementById("yourbets").innerHTML = "7 is my lucky number, bet accepted, your credits low?.";
	document.getElementById("bets7").innerHTML = "7";
                      }
    if (w8 == 0){  // display wager on tote board for 8
    toteEight = toteEight + x;
    tote8.innerHTML = toteEight;
    w8 = 1;
	document.getElementById("yourbets").innerHTML = "Number 8 accepted. Dont worry if your credits run out";
	document.getElementById("bets8").innerHTML = "8";
                      }
    if (w9 == 0){  // display wager on tote board for 9
    toteNine = toteNine + x;
    tote9.innerHTML = toteNine;
    w9 = 1;
	document.getElementById("yourbets").innerHTML = "9 bet accepted. If you run out of credits I will give 1000 more.";
	document.getElementById("bets9").innerHTML = "9";
                      }
    if (w10 == 0){  // display wager on tote board for 10
    toteTen = toteTen + x;
    tote10.innerHTML = toteTen;
    w10 = 1;
	document.getElementById("yourbets").innerHTML = "Number 10. Pick again when you have zero credits, I like you.";
	document.getElementById("bets10").innerHTML = "10";
                      }
    if (wJ == 0){  // display wager on tote board for J
    toteJack = toteJack + x;
    toteJ.innerHTML = toteJack;
    wJ = 1;
	document.getElementById("yourbets").innerHTML = "Jack bet accepted. You should do good in Multiplay.";
	document.getElementById("betsJ").innerHTML = "J";
                      }
    if (wQ == 0){  // display wager on tote board for Q
    toteQueen = toteQueen + x;
    toteQ.innerHTML = toteQueen;
    wQ = 1;
	document.getElementById("yourbets").innerHTML = "The queen says high. Not really, but hey, I got you !!!";
	document.getElementById("betsQ").innerHTML = "Q";
                      }
    if (wK == 0){  // display wager on tote board for K
    toteKing = toteKing + x;
    toteK.innerHTML = toteKing;
    wK = 1;
	document.getElementById("yourbets").innerHTML = "Your gonna look like a King with all these coins your getting.";
	document.getElementById("betsK").innerHTML = "K";
                      }
    if (wS == 0){  // display wager on tote board for Spade
    toteSpade = toteSpade + x;
    toteS.innerHTML = toteSpade;
    wS = 1;
	document.getElementById("yourbets").innerHTML = "Spades bet accepted. I gave you .1 of a coin just now.";
	document.getElementById("betsSpades").innerHTML = "Spades";
                      }
    if (wH == 0){  // display wager on tote board for Heart
    toteHeart = toteHeart + x;
    toteH.innerHTML = toteHeart;
    wH = 1;
	document.getElementById("yourbets").innerHTML = "Hearts bet accepted. 10 bets gets you 1 coin per hand.";
	document.getElementById("betsHearts").innerHTML = "Hearts";
                      }
    if (wC == 0){  // display wager on tote board for Club
    toteClub = toteClub + x;
    toteC.innerHTML = toteClub;
    wC = 1;
	document.getElementById("yourbets").innerHTML = "Clubs bet accepted. Bet often and grow your credits.";
    document.getElementById("betsClubs").innerHTML = "Clubs";
                		}
...
function updateDatabase() {
 var param = money // This is the <span> from the html file and it's also the value from line 1463
...
var params = "money_field=" + param;  // money_field is where I want to store the new value in the database
...
gfx[12]="images/floatingmug_com.png";
gfx[13]="images/countjokerbanner.png";
gfx[14]="images/vegashype.png";
gfx[15]="images/banner1.png";
gfx[16]="images/banner2.png";
gfx[17]="images/banner3.png";
gfx[18]="images/banner4.png";
gfx[19]="images/banner5.png";
gfx[20]="images/banner6.png";
gfx[21]="images/banner7.png";
gfx[22]="images/banner8.png";
gfx[23]="images/banner9.png";
gfx[24]="images/banner10.png";
gfx[25]="images/banner11.png";
gfx[26]="images/jokerd.png";
gfx[27]="images/wagir.png";
gfx[28]="images/gamernew.png";
gfx[29]="images/funshit.png";
gfx[30]="images/playnewgame.png";
gfx[31]="images/bigwii.png";
gfx[32]="images/airworthy.png";
gfx[33]="images/bluecalyx2.png";
gfx[34]="images/tripleforum2.png";
gfx[35]="images/classicrocktees2.png";
gfx[36]="images/xtremesurf_info.png";
gfx[37]="images/turbopays_com.png";
gfx[38]="images/freeads.png";
gfx[39]="images/dabjars.png";
gfx[40]="images/s-2_info.png";
gfx[41]="images/digiwidgy_com.png";
gfx[42]="images/iesa.png";
gfx[43]="images/stocksmart_us.png";
gfx[44]="images/getprofitadz_com.png";
...
lnk[10]="http://www.ebay.com/itm/Income-Opportunity-Website-For-Sale-Traffic-Exchange-Banner-Exchange-Game-/161333877745?pt=LH_DefaultDomain_0&hash=item25903f9bf1";
lnk[11]="http://www.ebay.com/itm/Income-Opportunity-Website-For-Sale-Traffic-Exchange-Banner-Exchange-Game-/161333877745?pt=LH_DefaultDomain_0&hash=item25903f9bf1";
lnk[12]="http://floatingmug.com/products/wht8-fm";
lnk[13]="http://countjoker.com";
lnk[14]="http://vegashype.com";
lnk[15]="http://imagecube.info";
lnk[16]="http://twitter-buttons.info";
lnk[17]="http://jumpingrankdomains.com";
lnk[18]="http://promotegoodwill.com";
lnk[19]="http://www.expireddomains4sale.com";
lnk[20]="http://goldenmoneytrail.com";
lnk[21]="http://www.govgrantsindex.com";
lnk[22]="http://martyslottosystem.com";
lnk[23]="http://www.retweets.xyz";
lnk[24]="http://cpamarketingsite.com";
lnk[25]="http://practice-poker.info";
lnk[26]="http://jokerd.com";
lnk[27]="http://wagir.com";
lnk[28]="http://gamernew.com";
lnk[29]="http://funshit.net";
lnk[30]="http://playnewgame.com";
lnk[31]="http://bigwii.com";
lnk[32]="http://airconditioningfresnoairworthy.com/fresno-air-conditioning-services/";
lnk[33]="http:///bluecalyx.com";
lnk[34]="http://tripleforum.com";
lnk[35]="http://classicrocktees.org/";
lnk[36]="http://xtremesurf.info";
lnk[37]="http://turbopays.com";
lnk[38]="http://free-ads.xyz";
lnk[39]="http://dabjars.com";
lnk[40]="http://s-2.info";
lnk[41]="http://digiwidgy.com";
lnk[42]="http://iesa.co";
lnk[43]="http://stocksmart.us";
lnk[44]="http://getprofitadz.com";
