...
?>
		<center>
		<td><h1><b>Update Link 6</b></h1><br><br>
...
<?php		
		...
		echo "<td>                           <a href=\"" .$row['lnksix'] . "\">    <img src=\"../upload/" . $row['gfxsix'] . "\"></a></td>   <td></td><td><input type=\"text\" maxlength=\"125\" name=\"lnksix\" placeholder=\"http://iCardCounting.com\"/></td><td><input type=\"submit\" value=\"Update Link 6\" name=\"submit\" /></td>";
		echo '</form>';
