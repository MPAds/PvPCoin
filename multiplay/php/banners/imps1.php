...
<td>
<h1><b>Banner 1</b></h1><br><img src="..//<?php
        echo $row["banner_image_url"];
?>"></a><br>
Banner 1 Current Allocated Impressions: <?php
        echo $row["gfximps"];
?>
...
<form method="POST" action="imps1process.php" enctype="multipart/form-data">
...
?></td>
    <td><input type="text" maxlength="125" name="imps" >
	    ...
	    <input type="hidden" maxlength="125" name="gfximps" 
		       value="<?php echo $row['gfximps'];?>"></td>
