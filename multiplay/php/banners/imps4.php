...
<td>
<h1><b>Banner 4</b></h1><br><img src="../upload/<?php
        echo $row["gfxfour"];
?>"></a><br>
Banner 4 Current Allocated Impressions: <?php
        echo $row["gfxfourimps"];
?>
...
<form method="POST" action="imps4process.php" enctype="multipart/form-data">
...
?></td>
    <td><input type="text" maxlength="125" name="imps" >
	    ...
	    <input type="hidden" maxlength="125" name="gfxfourimps" 
		       value="<?php echo $row['gfxfourimps'];?>"></td>
