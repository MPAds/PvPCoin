...
<td>
<h1><b>Banner 6</b></h1><br><img src="../upload/<?php
        echo $row["gfxsix"];
?>"></a><br>
Banner 6 Current Allocated Impressions: <?php
        echo $row["gfxsiximps"];
?>
...
<form method="POST" action="impsprocess.php" enctype="multipart/form-data">
...
?></td>
    <td><input type="text" maxlength="125" name="imps" >
	    ...
	    <input type="hidden" maxlength="125" name="gfxsiximps" 
		       value="<?php echo $row['gfxsiximps'];?>"></td>
