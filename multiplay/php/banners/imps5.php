...
<td>
<h1><b>Banner 5</b></h1><br><img src="../upload/<?php
        echo $row["gfxfive"];
?>"></a><br>
Banner 5 Current Allocated Impressions: <?php
        echo $row["gfxfiveimps"];
?>
...
<form method="POST" action="imps5process.php" enctype="multipart/form-data">
...
?></td>
    <td><input type="text" maxlength="125" name="imps" >
	    ...
	    <input type="hidden" maxlength="125" name="gfxfiveimps" 
		       value="<?php echo $row['gfxfiveimps'];?>"></td>
