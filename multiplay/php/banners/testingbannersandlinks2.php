...
<?php		
		...
		echo '<input type="submit" value="Update Link 1" name="submit" /></form>';
        ...
        echo '<input type="submit" value="Update Link 2" name="submit" /></form>';
		$stmt = $pdo->prepare("UPDATE banners SET lnktwo=:lnktwo");
        ...
        echo '<input type="submit" value="Update Link 3" name="submit" /></form>';
		$stmt = $pdo->prepare("UPDATE banners SET lnkthree=:lnkthree");
        ...
        echo '<input type="submit" value="Update Link 4" name="submit" /></form>';
		$stmt = $pdo->prepare("UPDATE banners SET lnkfour=:lnkfour");
        ...
        echo '<input type="submit" value="Update Link 5" name="submit" /></form>';
		$stmt = $pdo->prepare("UPDATE banners SET lnkfive=:lnkfive");
		...
		echo "</tr></table>";
        echo '<input type="submit" value="Update Link 6" name="submit" /></form>';
		$stmt = $pdo->prepare("UPDATE banners SET lnksix=:lnksix");
