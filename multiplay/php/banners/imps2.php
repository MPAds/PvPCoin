...
<td>
<h1><b>Banner 2</b></h1><br><img src="../upload/<?php
        echo $row["gfxtwo"];
?>"></a><br>
Banner 2 Current Allocated Impressions: <?php
        echo $row["gfxtwoimps"];
?>
...
<form method="POST" action="imps2process.php" enctype="multipart/form-data">
...
?></td>
    <td><input type="text" maxlength="125" name="imps" >
	    ...
	    <input type="hidden" maxlength="125" name="gfxtwoimps" 
		       value="<?php echo $row['gfxtwoimps'];?>"></td>
