...
if ($_SESSION['userid'])
    $pdo->beginTransaction();
		...
		echo "<tr><td align=center><font color=\"white\"><h1>Banner 2 Upload</h1><br><br><b>File size must be under 18 kB otherwise<br>the file will not upload<br>when you submit!</b></td></tr>";
		...
		echo "<tr><td align=center><font color=\"white\"><input type=\"submit\" value=\"Submit Banner 2\" name=\"submit\" /></font></td></tr>";
		echo '</form>';
		echo "</table>";
		
		$stmt = $pdo->prepare("UPDATE banners SET gfxtwo=:url");
